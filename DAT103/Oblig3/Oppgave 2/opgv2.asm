...
; Datasegment
section .bss
	siffer resb 4 ; Antall bytes som siffer kan lagre
...
_start:
	...
	mov edx,meldlen			; Lagrer lengden av meld i edx
	mov ecx,meld			; Lagrer meld i ecx
	mov ebx,STDOUT			; 
	mov eax,SYS_WRITE		; Skriver tall her
	int 80h
	...
	mov eax,ecx 			; Første tall/siffer lagres i reg eax
					...
					; Første tall er i eax
	
	call lessiffer 			; Les andre tall/siffer
					; vellykket: edx=0, tall i ecx (0 = True)
	cmp edx,0 				;Test om vellykket innlesning (compare edx == 0)
	jne Slutt	
